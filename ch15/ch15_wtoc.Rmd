...
output:
  xaringan::moon_reader:
    ...
    nature:
      beforeInit: "libs/remark-js/macro.js"
...
```{r echo=FALSE}
source("render_toc.R")
render_toc("ch15_wtoc.Rmd", toc_header_name = "Outline", base_level = 1,
  toc_depth = 2)
```
...
```{r echo=FALSE}
source("render_toc.R")
render_toc("ch15_wtoc.Rmd", toc_header_name = "Outline 2",
  base_level = 1,
  toc_depth = 2)
```

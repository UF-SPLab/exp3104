...
- A monkey is shown an object.
- Then it is presented with a two choice task.
- A reward is given for detecting the target object
...
# .font80[Streams for Information About What and Where]
- What pathway: also called the ventral pathway
- Where pathway: also called the dorsal pathway
- Both pathways: 
...
# .font80[Behavior of People Without Brain Damage]
...
## .font70[Explain the connection between the hippocampus and vision in light of Quiroga and coworkers (2005, 2008) studies.]
## .font70[Describe the method and results of research that shows that neurons can be shaped by experience in humans, as well as the expertise hypothesis in relation to the FFA.]
...
Figure 4.18 Size of response of a neuron in the monkey’s IT cortex that responds to face stimuli but not to non-face stimuli. 
...
# Distributed Representation: 2 Experiments
- fMRI experiment demonstrates distributed representation.
- Maximum activity occurs in separate areas of cortex.
- Huth and colleagues paradox
    - Results confirm earlier research that specific areas of the brain are responsible for perception of specific stimuli
- Also reveal a map that stretches across cortex

![](fig_4_21.png)

???

Figure 4.21 fMRI responses of the human brain to various types of stimuli: 
- (a) areas strongly activated by **houses, faces, and chairs**; 
- (b) area magnitude X each type of stimulus. 
...
Figure 4.22 Four frames from the movies viewed by subjects in Huth et al.’s (2012) experiment. The words on the right indicate categories that appear in the frames (n 5noun; v 5verb). 

Figure 4.23 The results of Huth et al.’s (2012) experiment, showing locations on the brain where the indicated categories are most likely to activate the brain. Colors indicate areas that respond similarly. For example, both areas marked “Animals” are yellow. 
...
Figure 4.28 (a) Greeble stimuli used by Gauthier. Participants were trained to name each different Greeble. (b) Brain responses to Greebles and faces before and after Greeble training. 

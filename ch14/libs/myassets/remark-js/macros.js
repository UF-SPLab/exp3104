...
remark.macros['image']= function(w, cl, a) {
  var url = this;
  if (!w) w = '';
  if (!cl) cl = '';
  if (!a) a = 'image';
  return '<img src="' + url + '" class="' + cl + '" style="max-width: ' + w + ' " alt="' + a + '" />';
};
...
remark.macros['positionText']= function (top, left, deg, z) {
  var el = this
  var f = (top, left, deg, z,el,...args) => '<div style="position: absolute; top:' + top + '; left:' + left +'; z-index:'+z+'; opacity:0.75;-ms-transform: tb-rl;-webkit-transform:  rotate(' + deg +');-moz-transform: rotate(' + deg +'); transform: :rotate(' + deg +');">'+ + 'more' + el + '</div>';
...
/*
remark.macros['positionText']= function (top, left, deg, z) {
 '<div style="position: absolute; top:' + top + '; left:' + left +'; z-index:'+z+'; opacity:0.75;-ms-transform: tb-rl;-webkit-transform:  rotate(' + deg +');-moz-transform: rotate(' + deg +'); transform: :rotate(' + deg +');">'+ this + '</div>';
}; 
*/

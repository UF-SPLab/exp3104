...
- Difference in sound pressure level reaching two ears
- Intensity reduction occurs for high frequency sounds for the far ear.
- Head casts an acoustic shadow.
   - Effect does not occur for low frequency sounds.
   - Cone of confusion  

![:positionImage 41%, 32%, 0deg, 550px](fig_12_3.png)
...
# .font70[The Auditory Scene: Separating Sound Sources]
.pull-left[

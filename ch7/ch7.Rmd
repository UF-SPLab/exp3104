...
![:positionImage -10%, -30%, 0deg, 1500px](biles1.jpg)

???
https://www.dallasnews.com/sports/other-sports/2021/06/25/flipping-incredible-simone-biles-competes-on-balance-beam-during-us-gymnastics-olympic-trials/
...
https://www.twincities.com/wp-content/uploads/2021/07/AP21203297552510.jpg?w=1569
...
### Apply the concepts of optic flow (invariance & FOE) <br/> to a person driving a car.
...
![:positionImage 32%, 10%, 0deg, 700px](fig_7_7ab.png)
...
![:positionImage 32%, 10%, 0deg, 700px](fig_7_7cd.png)
...
![:positionImage 15%, 10%, 0deg, 600px](fig_7_8.png)
...
### Identify the neurons and brain areas that are believed to be responsible for navigation
...
![:positionImage 45%, 0%, 0deg, 550px](fig_7_11a.png)

![:positionImage 38%, 60%, 0deg, 400px](fig_7_11b.png)
...
# The Brain's "GPS"
### Nobel Prize in Medicine or Physiology 2014
...
![:positionImage 12%, 80%, 0deg, 120px](Nobel_Prize.png)
![:positionImage  35%, 30%, 0deg, 350px](grid_place.png)
![:positionImage  55%, 68%, 0deg, 275px](place.png)
![:positionImage  55%, 0%, 0deg, 275px](grid.png)
...
<iframe width="530" height="315" src="https://www.youtube.com/embed/Vf_m65MLdLI?cc_load_policy=1&start=300" title="YouTube video player" frameborder="10" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

> "While I'm working I hear in the background, I hear this it's the sound that the brain makes when the animal is moving. I hear place cells firing as though the animal is running. Well I'm a little bit concerned I think we may be the a the rats making a break for it I turn around, and fortunately rat is not scurrying, you know off toward the door." 
...
> "No, the animals asleep he's sound asleep. What I'm hearing is REM sleep rapid eye movement sleep, or what you think of as dream sleep. The rat is dreaming he's dreaming of running on this track. Well this wasn't - I wasn't doing this experiment to study sleep and dreaming, but there clearly is something surprising here."
...
> "So, immediately, I start going to look at this data during sleep. And, what I find is indeed during sleep, immediately after running on one of these mazes. These patterns that you see here reappear. They're reactivated during sleep and in REM sleep indeed the animal is running. The place cells are firing. The animal is dreaming about running on the track. So, I immediately thought - 'I need to understand what's going on during sleep!'"
...
# .font80[The Physiology of Reaching and Grasping]
...
![:positionImage 40%, 0%, 0deg,  650px](PPA_reach_b.jpg)
![:positionImage 12%, 60%, 0deg, 350px](PPA_reach_a.jpg)
...
# .font70[The Physiology of Reaching and Grasping]
...
.pull-left[![](mirror1a.png)]
.pull-right[![](mirror1b.png)]

[https://www.youtube.com/embed/yacL60710hg?start=274](https://www.youtube.com/embed/yacL60710hg?start=274)
